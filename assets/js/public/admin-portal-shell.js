(() => {
  const styleLayers = [
    ...
    ['adminMediaLayoutV6Styles', './assets/css/public/admin-media-layout-v6.css?v=2.1-resizable-gallery']
  ];
  ...
  if (!document.getElementById('adminGamesTabsV4Script')) {
    ...
    script.src = './assets/js/public/admin-games-tabs-v4.js?v=2.2-shared-filter-column';
    script.defer = true;
